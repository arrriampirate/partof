...
export default class BlankH1 extends Component {
  ...
  handleEnter = (e) => {
    if (e.which === 13) {
      e.preventDefault();
      this.props.onAddComponent(this.props.columnId, 'p', this.props.options);
    }
  };
  ...
  render() {
    ...
    return (
      <div>
        <Options available={['center', 'small']} options={options} onChange={this.onChangeOption}/>
        <div
